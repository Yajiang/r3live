...
namespace feature {
    ...
    public:
        ...
        LFSHParam(double pointResolution) :
    ...
    class RPGAL_EXPORT_TEMPLATE FeatureEstimationLFSH : public FeatureEstimation<LFSHSignature30>
    {
    public:
        ...
        static geometry::PointCloud::Ptr ComputeFeatures(
            ...
            OUT std::vector<LFSHSignature30>& resultFeatures,
            const LFSHParam* param = nullptr,
            bool isUseCPU = true);

    public:
        
        FeatureEstimationLFSH() : FeatureEstimation(FeatureType::LFSH), neighborThreshold_(1)
        {}

        virtual bool Compute(std::vector<LFSHSignature30>& featurePoints, bool isUseCPU = true);
