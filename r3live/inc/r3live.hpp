...
public:
    ...
    std::deque<std::shared_ptr<ImageFrame>> m_queue_image_with_pose;
    std::list<std::shared_ptr<ImageFrame>> g_image_vec;
    ...
    std::vector<std::shared_ptr<RGBPoints>> m_last_added_rgb_pts_vec;
